...
/** A filter the viewer of a custom report may fill in */
export type CustomReportFilter = {
  __typename?: 'CustomReportFilter';
  /** Translated label for the field */
  display: Scalars['String']['output'];
  /** Attribute name to filter by */
  name: Scalars['String']['output'];
  /** Selectable values, empty unless type is select */
  options: Array<CustomReportFilterOption>;
  /** select, date, boolean or text */
  type: Scalars['String']['output'];
};

/** One selectable value of a custom report filter */
export type CustomReportFilterOption = {
  __typename?: 'CustomReportFilterOption';
  /** Translated label to show */
  label: Scalars['String']['output'];
  /** Value to send back when filtering */
  value: Scalars['String']['output'];
};

/** Autogenerated return type of CustomReportGenerate. */
export type CustomReportGeneratePayload = {
  __typename?: 'CustomReportGeneratePayload';
  /** The queued run */
  customReportRun?: Maybe<CustomReportRun>;
  /** Errors encountered during execution of the mutation. */
  errors?: Maybe<Array<UserError>>;
};
...
/** One generation (export) of a custom report */
export type CustomReportRun = {
  __typename?: 'CustomReportRun';
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Report this run belongs to */
  customReport: CustomReport;
  /** Path relative to api_path to download the file, nil while unavailable */
  downloadPath?: Maybe<Scalars['String']['output']>;
  /** Whether the file can be downloaded right now */
  downloadable: Scalars['Boolean']['output'];
  /** Reason the generation failed */
  errorMessage?: Maybe<Scalars['String']['output']>;
  /** When the generated file is removed */
  ...
  /** Nil until the total row count is known */
...
/** The connection type for KnowledgeBaseAnswer. */
export type KnowledgeBaseAnswerConnection = {
  __typename?: 'KnowledgeBaseAnswerConnection';
  /** A list of edges. */
  edges: Array<KnowledgeBaseAnswerEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
  /** Indicates the total number of available records. */
  totalCount: Scalars['Int']['output'];
...
/** An edge in a connection. */
export type KnowledgeBaseAnswerEdge = {
  __typename?: 'KnowledgeBaseAnswerEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
...
export type KnowledgeBaseCategory = {
  ...
  /** Ancestors of this category, root first, including itself */
  breadcrumb: Array<KnowledgeBaseCategory>;
...
export type KnowledgeBaseCategorySubcategoriesPayload = {
  __typename?: 'KnowledgeBaseCategorySubcategoriesPayload';
  /** The opened category (null at the knowledge base root); read its `breadcrumb` field for the header */
  category?: Maybe<KnowledgeBaseCategory>;
  /** Child categories visible to the current user, each carrying its own breadcrumb */
  subcategories: Array<KnowledgeBaseCategory>;
};
...
export type KnowledgeBaseContentUpdatesPayload = {
  ...
  /** IDs of the changed category and its ancestors (whose counts/visibility may change); empty for knowledge-base-wide changes */
...
export type Mutations = {
  ...
  /** Queue the generation of an exportable file for a custom report */
  customReportGenerate?: Maybe<CustomReportGeneratePayload>;
...
/** All available mutations */
export type MutationsCustomReportGenerateArgs = {
...
export type Queries = {
  ...
  /** Report generations started by the current user */
  customReportRuns: Array<CustomReportRun>;
  ...
  /** Fetch the active knowledge base for browsing (landing + language selector) */
  knowledgeBase?: Maybe<KnowledgeBase>;
  ...
  /** Fetch the paginated answers directly below a knowledge base category */
  knowledgeBaseAnswers: KnowledgeBaseAnswerConnection;
  /** Fetch a knowledge base node: its breadcrumb and the visible child categories (subcategories) */
  ...
  ticket: Ticket;
  /** Find knowledge base answers related to a ticket via vector similarity search */
  ticketAIRelatedKnowledgeBaseAnswers: TicketAiRelatedKnowledgeBaseAnswersResult;
...
/** All available queries */
export type QueriesCustomReportRunsArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
};
...
/** All available queries */
export type QueriesKnowledgeBaseArgs = {
...
/** All available queries */
export type QueriesKnowledgeBaseAnswersArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
...
/** All available queries */
export type QueriesKnowledgeBaseCategorySubcategoriesArgs = {
...
export type Subscriptions = {
  ...
  knowledgeBaseContentUpdates: KnowledgeBaseContentUpdatesPayload;
  ...
  /** Ping that the related knowledge base answers for a ticket may have changed */
  ticketAIRelatedKnowledgeBaseAnswersUpdates: TicketAiRelatedKnowledgeBaseAnswersUpdatesPayload;
...
/** All available subscriptions */
export type SubscriptionsTicketAiRelatedKnowledgeBaseAnswersUpdatesArgs = {
  ticketId: Scalars['ID']['input'];
};
...
export type Ticket = ObjectAttributeValuesInterface & TagsInterface & {
  ...
  /** Returns true if the AI summary is enabled for this ticket */
  aiSummaryEnabled?: Maybe<Scalars['Boolean']['output']>;
...
/** A knowledge base answer related to a ticket, found via vector similarity search */
export type TicketAiRelatedKnowledgeBaseAnswer = {
  __typename?: 'TicketAIRelatedKnowledgeBaseAnswer';
  /** Relevance score of the match (higher is more relevant) */
  score: Scalars['Float']['output'];
  /** The matching knowledge base answer translation */
  translation: KnowledgeBaseAnswerTranslation;
};

/** Result of a related knowledge base answers search for a ticket */
export type TicketAiRelatedKnowledgeBaseAnswersResult = {
  __typename?: 'TicketAIRelatedKnowledgeBaseAnswersResult';
  /** The related knowledge base answers, ordered by relevance. Null while the ticket summary is still being generated. */
  answers?: Maybe<Array<TicketAiRelatedKnowledgeBaseAnswer>>;
  /** Whether the ticket summary the search relies on is still being generated. Subscribe to the ping and refetch when it arrives. */
  pending: Scalars['Boolean']['output'];
};

/** Autogenerated return type of TicketAIRelatedKnowledgeBaseAnswersUpdates. */
export type TicketAiRelatedKnowledgeBaseAnswersUpdatesPayload = {
  __typename?: 'TicketAIRelatedKnowledgeBaseAnswersUpdatesPayload';
  /** Set when the embedding could not be produced; the client shows the error state instead of re-running the search */
  error?: Maybe<Scalars['String']['output']>;
  /** Identifier of the ticket whose related knowledge base answers may have changed (null on subscribe) */
