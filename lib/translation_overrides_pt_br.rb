...
module TranslationOverridesPtBr
  ...
  OVERRIDES = {
    ...
    'Columns' => 'Colunas',
    'Columns shown in the grid and in the exported file.' => 'Colunas exibidas no grid e no arquivo exportado.',
    'Filters available when viewing' => 'Filtros disponíveis na visualização',
    'Attributes the viewer may filter by. Leave empty to offer no filters.' => 'Atributos que quem visualiza pode filtrar. Deixe vazio para não oferecer filtros.',
    'Fixed scope of the report. Whoever opens it cannot widen this.' => 'Recorte fixo do relatório. Quem abre não consegue ampliá-lo.',
    'Unknown attribute(s): %s' => 'Atributo(s) desconhecido(s): %s',
