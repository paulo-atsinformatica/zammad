...
class Stats::TicketInProcess
  ...
  def self.generate(user)
    ...
    open_state_ids = Ticket::State.by_category_ids(:work_on)
    pending_state_ids = Ticket::State.by_category_ids(:pending_reminder)
    ...
    pending_action_state_ids = Ticket::State.by_category_ids(:pending_action)
