...
class SyncAtsTranslationsTotals < ActiveRecord::Migration[8.0]
  # Cada lote de strings novas em i18n/ats.pt-br.po precisa da própria migration:
  # uma migration roda uma única vez, então a anterior não reimporta o que foi
  # acrescentado depois dela.
  #
  # Em instalação nova quem importa é db/seeds.rb, que já roda Translation.sync.
  def up
